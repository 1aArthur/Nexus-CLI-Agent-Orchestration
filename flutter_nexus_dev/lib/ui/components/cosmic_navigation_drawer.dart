                  ...
                  _DrawerSection(
                    ...
                    items: [
                      ...
                      _DrawerItem(
                        ...
                        title: 'Terminal',
                        route: 'terminal',
                        isSelected: currentRoute == 'terminal',
                  ...
                  _DrawerSection(
                    ...
                    items: [
                      ...
                      _DrawerItem(
                        ...
                        route: 'cicd',
                        isSelected: currentRoute == 'cicd',
                        onTap: () => onNavigate('cicd'),
                      ),
                      _DrawerItem(
                  ...
                  _DrawerSection(
                    ...
                    items: [
                      _DrawerItem(
                        ...
                        title: 'Exa Search',
                        route: 'exa_search',
                        isSelected: currentRoute == 'exa_search',
                        onTap: () => onNavigate('exa_search'),
                      ),
                      _DrawerItem(
                        ...
                        route: 'orchestrator',
                        isSelected: currentRoute == 'orchestrator',
                        onTap: () => onNavigate('orchestrator'),
                      ),
                    ],
                  ),
                  _DrawerSection(
                    ...
                    items: [
                      _DrawerItem(
                        ...
                        title: 'Tools Hub',
                        route: 'tools_hub',
                        isSelected: currentRoute == 'tools_hub',
                        onTap: () => onNavigate('tools_hub'),
                      ),
                      _DrawerItem(
                        ...
                        title: 'MCP Tools',
                        route: 'mcp_tools',
                        isSelected: currentRoute == 'mcp_tools',
                        onTap: () => onNavigate('mcp_tools'),
                      ),
                      _DrawerItem(
                        ...
                        title: 'Skills',
                        route: 'skills',
                        isSelected: currentRoute == 'skills',
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(color: NexusTheme.emerald.withValues(alpha: 0.5), blurRadius: 8),
                          ],
                        ),
                      ),
